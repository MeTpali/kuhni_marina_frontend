...
mixin _$ProductDetailResponseDto {
  ...
  /// Serializes this ProductDetailResponseDto to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ProductDetailResponseDto
...
abstract class $ProductDetailResponseDtoCopyWith<$Res> {
  factory $ProductDetailResponseDtoCopyWith(
...
/// @nodoc
class _$ProductDetailResponseDtoCopyWithImpl<
  $Res,
...
class __$$ProductDetailResponseDtoImplCopyWithImpl<$Res>
    extends
        _$ProductDetailResponseDtoCopyWithImpl<
          $Res,
...
/// @nodoc
@JsonSerializable()
class _$ProductDetailResponseDtoImpl implements _ProductDetailResponseDto {
  const _$ProductDetailResponseDtoImpl({
  ...
  @override
  String toString() {
    return 'ProductDetailResponseDto(id: $id, name: $name, categoryId: $categoryId, type: $type, category: $category, createdAt: $createdAt, slug: $slug, description: $description, contentMarkdown: $contentMarkdown, price: $price, isNew: $isNew, isHit: $isHit, isActive: $isActive, attributes: $attributes, images: $images, updatedAt: $updatedAt, discount: $discount, message: $message)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$ProductDetailResponseDtoImplToJson(this);
  }
}

abstract class _ProductDetailResponseDto implements ProductDetailResponseDto {
  const factory _ProductDetailResponseDto({
