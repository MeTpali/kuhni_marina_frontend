...
import '../../services/campaigns/campaigns_remote_service.dart';
import '../../utils/response_error_mapper.dart';

class CampaignsRemoteRepository implements ICampaignsRepository {
  CampaignsRemoteRepository({required CampaignsRemoteService service})
      : _service = service;

  final CampaignsRemoteService _service;
