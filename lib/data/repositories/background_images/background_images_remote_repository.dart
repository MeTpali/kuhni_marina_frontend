...
import '../../services/background_images/background_images_remote_service.dart';
import '../../utils/response_error_mapper.dart';

class BackgroundImagesRemoteRepository implements IBackgroundImagesRepository {
  BackgroundImagesRemoteRepository({required BackgroundImagesRemoteService service})
    : _service = service;

  final BackgroundImagesRemoteService _service;
