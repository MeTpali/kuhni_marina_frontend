...
import '../../services/projects/projects_remote_service.dart';
import '../../utils/response_error_mapper.dart';

class ProjectsRemoteRepository implements IProjectsRepository {
  ProjectsRemoteRepository({required ProjectsRemoteService service})
      : _service = service;

  final ProjectsRemoteService _service;
