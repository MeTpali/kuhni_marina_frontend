...
class CatalogCard extends StatefulWidget {
  /// Высота карточки (включая метку новинка). Ширина считается по соотношению 150:230.
  final double? height;
...
class _CatalogCardState extends State<CatalogCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final height = widget.height ?? s.catalogCardDefaultHeight;
    final width = s.catalogCardWidthFromHeight(height);
