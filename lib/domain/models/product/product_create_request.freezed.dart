...
class _$ProductCreateRequestImpl implements _ProductCreateRequest {
  ...
  @override
  String toString() {
    return 'ProductCreateRequest(name: $name, categoryId: $categoryId, type: $type, slug: $slug, description: $description, contentMarkdown: $contentMarkdown, price: $price, isNew: $isNew, isHit: $isHit, attributes: $attributes, images: $images)';
  }
