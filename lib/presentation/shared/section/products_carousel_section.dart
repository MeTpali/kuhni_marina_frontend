...
import 'section_backdrop.dart';
import 'section_more_button.dart';

export 'section_backdrop.dart';

/// Секция с заголовком и горизонтальным списком карточек товаров.
class ProductsCarouselSection extends ConsumerWidget {
  const ProductsCarouselSection({
    ...
    this.onProductTap,
    this.onFavoriteTap,
    this.backdropStyle = SectionBackdropStyle.none,
  });
  ...
  final SectionBackdropStyle backdropStyle;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final glassVerticalEdge = backdropStyle == SectionBackdropStyle.none
