...
List<HomeWelcomeNavItem> buildHomeWelcomeNavItems({
  ...
  final hitsKitchensAsync = ref.watch(
    homeProductHitsProvider(ProductType.kitchen),
  );
  final newKitchensAsync = ref.watch(
    homeProductNewProvider(ProductType.kitchen),
  );
  final hitsFurnitureAsync = ref.watch(
    homeProductHitsProvider(ProductType.furniture),
  );
  final newFurnitureAsync = ref.watch(
    homeProductNewProvider(ProductType.furniture),
  );
