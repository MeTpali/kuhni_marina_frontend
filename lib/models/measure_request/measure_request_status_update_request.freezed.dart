...
MeasureRequestStatusUpdateRequest _$MeasureRequestStatusUpdateRequestFromJson(
  Map<String, dynamic> json,
) {
  return _MeasureRequestStatusUpdateRequest.fromJson(json);
}
...
mixin _$MeasureRequestStatusUpdateRequest {
  ...
  /// Serializes this MeasureRequestStatusUpdateRequest to a JSON map.
...
abstract class $MeasureRequestStatusUpdateRequestCopyWith<$Res> {
  factory $MeasureRequestStatusUpdateRequestCopyWith(
    ...
    $Res Function(MeasureRequestStatusUpdateRequest) then,
      ...
      >;
  @useResult
  $Res call({@JsonKey(name: 'status') MeasureRequestStatus status});
}
...
class _$MeasureRequestStatusUpdateRequestImpl
  ...
  const _$MeasureRequestStatusUpdateRequestImpl({
    @JsonKey(name: 'status') required this.status,
  });

  factory _$MeasureRequestStatusUpdateRequestImpl.fromJson(
    Map<String, dynamic> json,
  ) => _$$MeasureRequestStatusUpdateRequestImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$MeasureRequestStatusUpdateRequestImplToJson(this);
  }
}
...
abstract class _MeasureRequestStatusUpdateRequest
  ...
  factory _MeasureRequestStatusUpdateRequest.fromJson(
    Map<String, dynamic> json,
  ) = _$MeasureRequestStatusUpdateRequestImpl.fromJson;
