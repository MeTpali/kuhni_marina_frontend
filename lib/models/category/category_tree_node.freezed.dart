...
CategoryTreeNode _$CategoryTreeNodeFromJson(Map<String, dynamic> json) {
  return _CategoryTreeNode.fromJson(json);
}
...
mixin _$CategoryTreeNode {
  ...
  /// Serializes this CategoryTreeNode to a JSON map.
...
abstract class $CategoryTreeNodeCopyWith<$Res> {
  ...
  $Res call({
    ...
    @JsonKey(name: 'children') List<CategoryTreeNode> children,
...
class _$CategoryTreeNodeImpl implements _CategoryTreeNode {
  const _$CategoryTreeNodeImpl({
    ...
    @JsonKey(name: 'children') final List<CategoryTreeNode> children = const [],
    @JsonKey(name: 'message') this.message,
  }) : _children = children;

  factory _$CategoryTreeNodeImpl.fromJson(Map<String, dynamic> json) =>
      _$$CategoryTreeNodeImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CategoryTreeNode(id: $id, name: $name, slug: $slug, type: $type, parentId: $parentId, isActive: $isActive, children: $children, message: $message)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$CategoryTreeNodeImplToJson(this);
  }
}
...
abstract class _CategoryTreeNode implements CategoryTreeNode {
  const factory _CategoryTreeNode({
    ...
    @JsonKey(name: 'children') final List<CategoryTreeNode> children,
    @JsonKey(name: 'message') final String? message,
  }) = _$CategoryTreeNodeImpl;

  factory _CategoryTreeNode.fromJson(Map<String, dynamic> json) =
      _$CategoryTreeNodeImpl.fromJson;
